...
class BindingpairPDBDownload(View):
    ...
    def get(self, request, binding_partner_id, *args, **kwargs):
        ...
        pdb_filename = f"{binding_partner.structure.pdb_code.index}_{binding_partner.chemokine_name}_{binding_partner.partner_name}.pdb"
...
class ChemokineBindingPartnerDetailView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['interactions'] = interactions
        context["interaction_total"] = interactions.count()
